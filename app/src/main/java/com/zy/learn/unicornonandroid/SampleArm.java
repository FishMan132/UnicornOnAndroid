...
public class SampleArm {
    ...
    // code to be emulated
    public static final byte[] ARM_CODE = {55, 0, (byte) 0xa0, (byte) 0xe3, 3, 16, 66,
        (byte) 0xe0}; // mov r0, #0x37; sub r1, r2, r3
    ...
    private static class MyCodeHook implements CodeHook {
        ...
        public void hook(Unicorn u, long address, int size, Object user_data) {
            System.out
                .print(String.format(">>> Tracing instruction at 0x%x, instruction size = 0x%x\n", address, size));
        }
    }
...
//        u.hook_add(new MyCodeHook(), ADDRESS, ADDRESS, null);
        ...
        System.out.print(String.format(".c= 0x%x\n", r0.intValue()));
